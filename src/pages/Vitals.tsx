      ...
      <main className="container py-6">
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              { label: "Avg Heart Rate", value: "71 bpm", icon: Heart, color: "heart" },
              { label: "Avg Oxygen", value: "98%", icon: Droplets, color: "oxygen" },
              { label: "Avg Temperature", value: "36.5°C", icon: Thermometer, color: "temp" },
            ].map((stat) => (
              <div
                key={stat.label}
